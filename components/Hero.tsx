        ...
        >
          ...
          <motion.div variants={itemVariants}>
            <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto leading-relaxed">
              Building production AI-powered applications with LLMs, RAG systems, and intelligent
              automation workflows. 7+ years of experience shipping end-to-end features from
              backend architecture to frontend interfaces.
            </p>
          </motion.div>
